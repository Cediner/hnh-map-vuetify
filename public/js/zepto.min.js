/* Zepto v1.2.0-30-gb5ed8d6 - zepto event ajax form ie data - zeptojs.com/license */
!function (t, e) {
    ...
    var e = function () {
        ...
        function z(t) {
            return k(t) && !F(t) && Object.getPrototypeOf(t) == Object.prototype
        }
        ...
        function X(t, r, i) {
            for (n in r) i && (z(r[n]) || A(r[n])) ? (z(r[n]) && !z(t[n]) && (t[n] = {}), A(r[n]) && !A(t[n]) && (t[n] = []), X(t[n], r[n], i)) : r[n] !== e && (t[n] = r[n])
        }
        ...
        function Q(t, e) {
            e(t);
            for (var n = 0, r = t.childNodes.length; r > n; n++) Q(t.childNodes[n], e)
        }

        var e, n, r, i, N, O, o = [], a = o.concat, s = o.filter, u = o.slice, f = t.document, c = {}, l = {},
            ...
            w = /^[\w-]*$/, T = {}, S = T.toString, C = {}, P = f.createElement("div"), D = {
                tabindex: "tabIndex",
                readonly: "readOnly",
                "for": "htmlFor",
                "class": "className",
        ...
        return C.matches = function (t, e) {
            ...
            return o && (i = P).appendChild(t), r = ~C.qsa(i, e).indexOf(t), o && P.removeChild(t), r
        }, N = function (t) {
            ...
            var o, a, s;
            return d.test(t) && (o = r(f.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(m, "<$1></$2>")), n === e && (n = p.test(t) && RegExp.$1), n in j || (n = "*"), s = j[n], s.innerHTML = "" + t, o = r.each(u.call(s.childNodes), function () {
                s.removeChild(this)
            })), z(i) && (a = r(o), r.each(i, function (t, e) {
            ...
            var i;
            if (!t) return C.Z();
            if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && p.test(t)) i = C.fragment(t, RegExp.$1, n), t = null; else {
                if (n !== e) return r(n).find(t);
                i = C.qsa(f, t)
            } else {
                if ($(t)) return r(f).ready(t);
                if (C.isZ(t)) return t;
                if (A(t)) i = Z(t); else if (k(t)) i = [t], t = null; else if (p.test(t)) i = C.fragment(t.trim(), RegExp.$1, n), t = null; else {
                    if (n !== e) return r(n).find(t);
                    i = C.qsa(f, t)
                }
            }
            ...
            return t.getElementById && a && r ? (n = t.getElementById(o)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType && 11 !== t.nodeType ? [] : u.call(a && !r && t.getElementsByClassName ? i ? t.getElementsByClassName(o) : t.getElementsByTagName(e) : t.querySelectorAll(e))
        }, r.contains = f.documentElement.contains ? function (t, e) {
            return t !== e && t.contains(e)
        } : function (t, e) {
            for (; e && (e = e.parentNode);) if (e === t) return !0;
            return !1
        }, r.type = L, r.isFunction = $, r.isWindow = F, r.isArray = A, r.isPlainObject = z, r.isEmptyObject = function (t) {
            var e;
            for (e in t) return !1;
            return !0
        ...
        }, r.camelCase = N, r.trim = function (t) {
            return null == t ? "" : String.prototype.trim.call(t)
        }, r.uuid = 0, r.support = {}, r.expr = {}, r.noop = function () {
        }, r.map = function (t, e) {
            var n, i, o, r = [];
            if (R(t)) for (i = 0; i < t.length; i++) n = e(t[i], i), null != n && r.push(n); else for (o in t) n = e(t[o], o), null != n && r.push(n);
            return q(r)
        }, r.each = function (t, e) {
            var n, r;
            if (R(t)) {
            ...
            ready: function (e) {
                if ("complete" === f.readyState || "loading" !== f.readyState && !f.documentElement.doScroll) setTimeout(function () {
                    ...
                    var n = function () {
                        f.removeEventListener("DOMContentLoaded", n, !1), t.removeEventListener("load", n, !1), e(r)
                    };
            ...
            filter: function (t) {
                return $(t) ? this.not(this.not(t)) : r(s.call(this, function (e) {
            ...
            not: function (t) {
                ...
                if ($(t) && t.call !== e) this.each(function (e) {
                    ...
                    var i = "string" == typeof t ? this.filter(t) : R(t) && $(t.item) ? u.call(t) : r(t);
            ...
            has: function (t) {
                return this.filter(function () {
                    return k(t) ? r.contains(this, t) : r(this).find(t).size()
                })
            },
            eq: function (t) {
            ...
            find: function (t) {
                ...
                }) : 1 == this.length ? r(C.qsa(this[0], t)) : this.map(function () {
                    return C.qsa(this, t)
                }) : r()
            },
            closest: function (t, e) {
                ...
                return this.each(function (r, o) {
                    for (; o && !(i ? i.indexOf(o) >= 0 : C.matches(o, t));) o = o !== e && !M(o) && o.parentNode;
            ...
            parent: function (t) {
                return J(O(this.pluck("parentNode")), t)
            },
            children: function (t) {
            ...
            html: function (t) {
                return 0 in arguments ? this.each(function (e) {
                    ...
                    r(this).empty().append(W(this, t, e, n))
            ...
            attr: function (t, r) {
                ...
                return "string" != typeof t || 1 in arguments ? this.each(function (e) {
                    if (1 === this.nodeType) if (k(t)) for (n in t) Y(this, n, t[n]); else Y(this, t, W(this, r, e, this.getAttribute(t)))
            ...
            prop: function (t, e) {
                return t = D[t] || t, "string" != typeof t || 1 in arguments ? this.each(function (r) {
                    if (k(t)) for (n in t) this[D[n] || n] = t[n]; else this[t] = W(this, e, r, this[t])
                }) : this[0] && this[0][t]
            },
            ...
            offset: function (e) {
                if (e) return this.each(function (t) {
                    var n = r(this), i = W(this, e, t, n.offset()), o = n.offsetParent().offset(),
            ...
            css: function (t, e) {
                if (arguments.length < 2) {
                    ...
                    if ("string" == typeof t) {
                        if (!i) return;
                        return i.style[N(t)] || getComputedStyle(i, "").getPropertyValue(t)
                    }
                    if (A(t)) {
                        if (!i) return;
                        var o = {}, a = getComputedStyle(i, "");
                        return r.each(t, function (t, e) {
                            o[e] = i.style[N(e)] || a.getPropertyValue(e)
                        }), o
                    }
                }
                var s = "";
                if ("string" == L(t)) e || 0 === e ? s = H(t) + ":" + I(t, e) : this.each(function () {
                    this.style.removeProperty(H(t))
                }); else for (n in t) t[n] || 0 === t[n] ? s += H(n) + ":" + I(n, t[n]) + ";" : this.each(function () {
                    this.style.removeProperty(H(n))
                });
                return this.each(function () {
            ...
            addClass: function (t) {
                return t ? this.each(function (e) {
                    if ("className" in this) {
                        i = [];
                        var n = G(this), o = W(this, t, e, n);
                        o.split(/\s+/g).forEach(function (t) {
                            r(this).hasClass(t) || i.push(t)
                        }, this), i.length && G(this, n + (n ? " " : "") + i.join(" "))
                    }
                }) : this
            },
            removeClass: function (t) {
                return this.each(function (n) {
                    if ("className" in this) {
                        ...
                        i = G(this), W(this, t, n, i).split(/\s+/g).forEach(function (t) {
                            i = i.replace(V(t), " ")
                        }), G(this, i.trim())
                    }
                })
            ...
            toggleClass: function (t, n) {
                return t ? this.each(function (i) {
                    var o = r(this), a = W(this, t, i, G(this));
            ...
            r.fn[t] = function (i) {
                var o, a = this[0];
                return i === e ? F(a) ? a["inner" + n] : M(a) ? a.documentElement["scroll" + n] : (o = this.offset()) && o[t] : this.each(function (e) {
                    a = r(this), a.css(t, W(this, i, e, a[t]()))
                })
            }
        }), x.forEach(function (n, i) {
            var o = i % 2;
            r.fn[n] = function () {
                var n, s, a = r.map(arguments, function (t) {
                    var i = [];
                    return n = L(t), "array" == n ? (t.forEach(function (t) {
                        return t.nodeType !== e ? i.push(t) : r.zepto.isZ(t) ? i = i.concat(t.get()) : void (i = i.concat(C.fragment(t)))
                    }), i) : "object" == n || null == t ? t : C.fragment(t)
                }), u = this.length > 1;
                return a.length < 1 ? this : this.each(function (e, n) {
                    s = o ? n : n.parentNode, n = 0 == i ? n.nextSibling : 1 == i ? n.firstChild : 2 == i ? n : null;
                    var c = r.contains(f.documentElement, s);
                    a.forEach(function (e) {
                        if (u) e = e.cloneNode(!0); else if (!s) return r(e).remove();
                        s.insertBefore(e, n), c && Q(e, function (e) {
        ...
        }), C.Z.prototype = U.prototype = r.fn, C.uniq = O, C.deserializeValue = K, r.zepto = C, r
    }();
    return t.Zepto = e, void 0 === t.$ && (t.$ = e), function (e) {
        ...
        function y(t, n, i, o, a, u, f) {
            var c = h(t), p = s[c] || (s[c] = []);
            n.split(/\s/).forEach(function (n) {
                if ("ready" == n) return e(document).ready(i);
                var s = d(n);
                s.fn = i, s.sel = a, s.e in l && (i = function (t) {
                ...
                }, s.i = p.length, p.push(s), "addEventListener" in t && t.addEventListener(v(s.e), s.proxy, g(s, f))
            })
        }
        ...
        function x(t, e, n, r, i) {
            ...
            (e || "").split(/\s/).forEach(function (e) {
                p(t, e, n, r).forEach(function (e) {
                    delete s[o][e.i], "removeEventListener" in t && t.removeEventListener(v(e.e), e.proxy, g(e, i))
                })
            })
        }
        ...
        var r, n = 1, i = Array.prototype.slice, o = e.isFunction, a = function (t) {
                return "string" == typeof t
            }, s = {}, u = {}, f = "onfocusin" in t, c = {focus: "focusin", blur: "focusout"},
        ...
        e.fn.delegate = function (t, e, n) {
        ...
        }, e.fn.on = function (t, n, s, u, f) {
            var c, l, h = this;
            return t && !a(t) ? (e.each(t, function (t, e) {
                h.on(t, n, s, e, f)
            }), h) : (a(n) || o(u) || u === !1 || (u = s, s = n, n = r), (u === r || s === !1) && (u = s, s = r), u === !1 && (u = E), h.each(function (r, o) {
                f && (c = function (t) {
                    return x(o, t.type, u), u.apply(this, arguments)
                }), n && (l = function (t) {
                    var r, a = e(t.target).closest(n, o).get(0);
                    return a && a !== o ? (r = e.extend(S(t), {
                        currentTarget: a,
                        liveFired: o
                    }), (c || u).apply(a, [r].concat(i.call(arguments, 1)))) : void 0
                }), y(o, t, u, s, n, l || c)
            }))
            ...
            return t && !a(t) ? (e.each(t, function (t, e) {
                s.off(t, n, e)
            }), s) : (a(n) || o(i) || i === !1 || (i = n, n = r), i === !1 && (i = E), s.each(function () {
                x(this, t, i, n)
            }))
        }, e.fn.trigger = function (t, n) {
            return t = a(t) || e.isPlainObject(t) ? e.Event(t) : T(t), t._args = n, this.each(function () {
            ...
            return this.each(function (o, s) {
                r = S(a(t) ? e.Event(t) : t), r._args = n, r.target = s, e.each(p(s, t.type || t), function (t, e) {
        ...
        function w(t) {
            return t && (t = t.split(";", 2)[0]), t && (t == c ? "html" : t == f ? "json" : s.test(t) ? "script" : u.test(t) && "xml") || "text"
        }
        ...
        function O(t, n, r, i) {
            ...
            e.each(n, function (n, u) {
                o = e.type(u), i && (n = r ? i : i + "[" + (s || "object" == o || "array" == o ? n : "") + "]"), !i && a ? t.add(u.name, u.value) : "array" == o || !r && "object" == o ? O(t, u, r, n) : t.add(n, u)
            })
        }

        var i, o, n = +new Date, r = t.document, a = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
            s = /^(?:text|application)\/javascript/i, u = /^(?:text|application)\/xml/i, f = "application/json",
        ...
        h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (i, o) {
            ...
            var c, p, a = i.jsonpCallback, s = (e.isFunction(a) ? a() : a) || "Zepto" + n++,
                u = r.createElement("script"), f = t[s], l = function (t) {
                    e(u).triggerHandler("error", t || "abort")
                }, h = {abort: l};
            return o && o.promise(h), e(u).on("load error", function (n, r) {
                clearTimeout(p), e(u).off().remove(), "error" != n.type && c ? y(c[0], h, i, o) : x(null, r || "error", h, i, o), t[s] = f, c && e.isFunction(f) && f(c[0]), f = c = void 0
            }), v(h, i) === !1 ? (l("abort"), h) : (t[s] = function () {
                c = arguments
            }, u.src = i.url.replace(/\?(.+)=\?/, "?$1=" + s), r.head.appendChild(u), i.timeout > 0 && (p = setTimeout(function () {
                l("timeout")
            }, i.timeout)), h)
        }, e.ajaxSettings = {
            type: "GET",
            ...
            var u, f, a = e.extend({}, n || {}), s = e.Deferred && e.Deferred();
            for (i in e.ajaxSettings) void 0 === a[i] && (a[i] = e.ajaxSettings[i]);
            m(a), a.crossDomain || (u = r.createElement("a"), u.href = a.url, u.href = u.href, a.crossDomain = h.protocol + "//" + h.host != u.protocol + "//" + u.host), a.url || (a.url = t.location.toString()), (f = a.url.indexOf("#")) > -1 && (a.url = a.url.slice(0, f)), S(a);
            var c = a.dataType, p = /\?.+=\?/.test(a.url);
            if (p && (c = "jsonp"), a.cache !== !1 && (n && n.cache === !0 || "script" != c && "jsonp" != c) || (a.url = T(a.url, "_=" + Date.now())), "jsonp" == c) return p || (a.url = T(a.url, a.jsonp ? a.jsonp + "=?" : a.jsonp === !1 ? "" : "callback=?")), e.ajaxJSONP(a, s);
            var P, d = a.accepts[c], g = {}, b = function (t, e) {
                g[t.toLowerCase()] = [t, e]
            }, C = /^([\w-]+:)\/\//.test(a.url) ? RegExp.$1 : t.location.protocol, N = a.xhr(), O = N.setRequestHeader;
            if (s && s.promise(N), a.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", d || "*/*"), (d = a.mimeType || d) && (d.indexOf(",") > -1 && (d = d.split(",", 2)[0]), N.overrideMimeType && N.overrideMimeType(d)), (a.contentType || a.contentType !== !1 && a.data && "GET" != a.type.toUpperCase()) && b("Content-Type", a.contentType || "application/x-www-form-urlencoded"), a.headers) for (o in a.headers) b(o, a.headers[o]);
            if (N.setRequestHeader = b, N.onreadystatechange = function () {
                if (4 == N.readyState) {
                    ...
                    if (N.status >= 200 && N.status < 300 || 304 == N.status || 0 == N.status && "file:" == C) {
                        if (c = c || w(a.mimeType || N.getResponseHeader("content-type")), "arraybuffer" == N.responseType || "blob" == N.responseType) t = N.response; else {
                            t = N.responseText;
                            try {
                                t = E(t, c, a), "script" == c ? (1, eval)(t) : "xml" == c ? t = N.responseXML : "json" == c && (t = l.test(t) ? null : e.parseJSON(t))
                            } catch (r) {
                                n = r
                            }
                            if (n) return x(n, "parsererror", N, a, s)
                        }
                        y(t, N, a, s)
                    } else x(N.statusText || null, N.status ? "error" : "abort", N, a, s)
                }
            }, v(N, a) === !1) return N.abort(), x(null, "abort", N, a, s), N;
            var D = "async" in a ? a.async : !0;
            if (N.open(a.type, a.url, D, a.username, a.password), a.xhrFields) for (o in a.xhrFields) N[o] = a.xhrFields[o];
            for (o in g) O.apply(N, g[o]);
            return a.timeout > 0 && (P = setTimeout(function () {
                N.onreadystatechange = j, N.abort(), x(null, "timeout", N, a, s)
            }, a.timeout)), N.send(a.data ? a.data : null), N
        }, e.get = function () {
            ...
            var s, i = this, o = t.split(/\s/), u = C(t, n, r), f = u.success;
            return o.length > 1 && (u.url = o[0], s = o[1]), u.success = function (t) {
                i.html(s ? e("<div>").html(t.replace(a, "")).find(s) : t), f && f.apply(i, arguments)
            }, e.ajax(u), this
        };
        ...
        function s(n, o, a) {
            var s = n[i] || (n[i] = ++t.uuid), f = e[s] || (e[s] = u(n));
            return void 0 !== o && (f[r(o)] = a), f
        }
        ...
        var e = {}, n = t.fn.data, r = t.camelCase, i = t.expando = "Zepto" + +new Date, o = [];
